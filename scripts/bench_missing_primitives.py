#!/usr/bin/env python3
"""
Benchmark missing atomic primitives for primitive-calibrated baseline plots.

Runs each primitive 1,000 times and prints average latency in milliseconds.
This script intentionally measures local machine performance only; it does not
contain fallback constants.
"""
