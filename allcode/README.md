...
| `allcode_flattened/` | Flattened code bundle with selected scripts copied into one folder for review. |
...
The `allcode_flattened/` folder is a flattened review bundle. It keeps many
source files in one place with filenames that show where they came from. The
structured folders should be used for normal project work.
